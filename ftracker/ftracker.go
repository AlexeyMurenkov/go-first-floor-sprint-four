...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	return (walkingCaloriesWeightMultiplier + walkingSpeedHeightMultiplier*math.Pow(meanSpeed, 2)/heightInM) * weight * duration * minInH
}
